...
class CheckSpringInspection extends StatelessWidget {
  const CheckSpringInspection({super.key});
        ...
        child: SizedBox(
          ...
          child: Obx(()=>ListView.builder(
            physics: NeverScrollableScrollPhysics(),
              shrinkWrap: true,
              itemCount: controller.hiveInspectionModels.length,
              itemBuilder: (context, index) => SpringInspectionWidget(
                  actions: controller.hiveInspectionModels[index].actions,
                  dateTime: controller.hiveInspectionModels[index].createdDate),
            ),
          ),
        ));
  }
...
class SpringInspectionWidget extends StatelessWidget {
  final DateTime dateTime;

  const SpringInspectionWidget(
      {super.key, required this.actions, required this.dateTime});
