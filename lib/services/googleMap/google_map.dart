...
class GoogleMapsService {
  ...
  Future<List<Placemark>> getAddressThroughLatLong({required double lat,required double long }) async {
    print("Called");
    ...
    print('${placeMarks[0].name}, ${placeMarks[0].subLocality} ${placeMarks[0].administrativeArea}, ${placeMarks[0].country}');
