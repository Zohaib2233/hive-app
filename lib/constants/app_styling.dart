...
double h(BuildContext context, double value) {
  return MediaQuery.of(context).size.height * value * 0.0012;
}

double w(BuildContext context, double value) {
  return MediaQuery.of(context).size.width * value * 0.0023;
}
...
double f(BuildContext context, double value) {
  return MediaQuery.of(context).size.shortestSide * value * 0.0023;
}
